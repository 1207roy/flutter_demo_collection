...
class AudioRemote extends StatefulWidget {
  final String _audioURL;

  AudioRemote({@required audioURL})
      : _audioURL = audioURL,
        assert(audioURL != null);

  @override
  _AudioRemoteState createState() => _AudioRemoteState();
}

class _AudioRemoteState extends State<AudioRemote> {
  ...
  startPlaying() async {
    if (!isStarted) {
      await audioPlayer.play(widget._audioURL);
      isStarted = true;
    } else
